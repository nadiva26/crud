        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="dist/img/1.jpeg" class="user-image" alt="User Image">
              <span class="hidden-xs">Nadivaa</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="dist/img/1.jpeg" class="img-circle" alt="User Image">

                <p>
                  Nadivaa - Web Developer
...
<ul class="sidebar-menu">
      ...
      <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="index.php?page=data_produk"><i class="glyphicon glyphicon-education"></i> <span>Data Produk</span></a></li>
          </ul>
      </li>
      <li class="treeview">
          <a href="#">
            ...
            <ul class="treeview-menu">
            <li><a href="index.php?page=data_transaksi"><i class="glyphicon glyphicon-education"></i> <span>Kasir</span></a></li>
          </ul>
